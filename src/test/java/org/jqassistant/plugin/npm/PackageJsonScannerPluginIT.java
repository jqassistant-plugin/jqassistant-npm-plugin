...
public class PackageJsonScannerPluginIT extends AbstractPluginIT {
    ...
    @Test
    void authorAsString() {
        File file = new File(getClassesDirectory(PackageJsonScannerPluginIT.class), "author-as-string/package.json");

        PackageDescriptor packageJson = getScanner().scan(file, "/author-as-string/package.json", DefaultScope.NONE);
